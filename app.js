...
var createNewTaskElement=function(taskString){
    ...
    label.className='wrapper-actions--label wrapper-actions--item';
    deleteButtonImg.className = 'button--img';

    //Each elements, needs appending
    checkBox.type="checkbox";
    checkBox.className = 'wrapper-actions--checkbox';
    editInput.type="text";
    editInput.className="wrapper-actions--input wrapper-actions--item";
